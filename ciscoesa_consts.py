...
CISCOESA_JSON_COMMIT_MSG = "commit_message"
...
CISCOESA_ERR_SERVER_CONNECTIVITY = "Connection failed"
...
CISCOESA_CONNECTIVITY_TEST_MSG = "Querying endpoint to verify the credentials provided"
CISCOESA_TEST_CONNECTIVITY_FAILED = "Test Connectivity Failed"
...
CISCOESA_LIST_DICTIONARY_SUCCESS_MSG = "Successfully listed all entries of dictionary"
CISCOESA_LIST_DICTIONARY_ERROR_MSG = "Error occurred while attempting to list dictionary \"{dictionary_name}\": {error}"
CISCOESA_ADD_DICTIONARY_SUCCESS_MSG = "Successfully added entry to dictionary"
CISCOESA_ADD_DICTIONARY_ERROR_MSG = "Error occurred while attempting to add dictionary entry to \"{dictionary_name}\": {error}"
...
CISCOESA_VALIDATE_INTEGER_MSG = "Please provide a valid integer value in the {key} parameter"
